 ...
 * @author munif
 */
public class GumgaBooleanUserType extends MutableUserType {
    ...
    public void nullSafeSet(final PreparedStatement preparedStatement,
        ...
        if (null == value) {
            ...
            final GumgaBoolean object = (GumgaBoolean) value;
            preparedStatement.setBoolean(property, object.getValue());
        }
    }
